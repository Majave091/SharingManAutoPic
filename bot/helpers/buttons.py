...
class HelperButtons:
    ...
    Menu: List[List[Tuple[str, str]]] = [
        ...
        [("Picture Start", "menu image"), ("Picture Force", "menu hunter")],
    ...
    Image: List[List[Tuple[str, str]]] = [
        [("« Back", "settings"), ("Set", "update image")]
    ]
    Image_: List[List[Tuple[str, str]]] = [[("« Back", "menu image")]]
    Hunter: List[List[Tuple[str, str]]] = [
        [("« Back", "settings"), ("Set", "update hunter")]
    ]
    Hunter_: List[List[Tuple[str, str]]] = [[("« Back", "menu hunter")]]
